                ...
                <div className="flex flex-col items-center space-y-8">
                    <div className="w-full max-w-2xl">
                        {currentCard ? (
                            ...
                            <div className="w-full h-72 flex items-center justify-center bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl">
                                <p className="text-sm text-slate-500">No card data available</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button 
                            ...
                            disabled={selectedSet.cards.length <= 1}
                            className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl shadow-sm transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
                        >
                            Next
                            <ChevronRight 
                             className="w-4 h-4 group-hover:translate-x-0.5 transition-transform duration-200"
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3 justify-end pt-2">
                        <button
                            ...
                            disabled={deleting}
                            className="px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disable:opacity-50 disabled:cursor-not-allowed"
                        >
                            Cancel
                        </button>
                        <button
