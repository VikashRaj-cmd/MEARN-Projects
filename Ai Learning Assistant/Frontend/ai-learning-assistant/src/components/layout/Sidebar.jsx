...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  <aside 
    className={`fixed top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-lg border-r border-slate-200/60 z-50 md:w-64 md:shrink-0 md:flex md:flex-col md:translate-x-0 transition-transform duration-300 ease-in-out ${
  ...
  >
        ...
        <div className="flex items-center justify-between h-16 px-5 border-b border-slate-200/60">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-sm md:text-base font-bold text-slate-900 tracking-tight">Aethron</h1>
            </div>
        ...
        <div className="px-3 py-4 border-t border-slate-200/60">
            <button 
              ...
              className="group flex items-center gap-3 w-full px-3 py-2.5 text-sm font-semibold text-slate-700 hover:bg-red-50 hover:text-red-600 rounded-xl transition-all duration-200"
            >
                <LogOut
                  size={18}
                  strokeWidth={2.5}
