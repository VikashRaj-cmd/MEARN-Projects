        ...
        <div className="bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          ...
          {dashboardData.recentActivity && (dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0) ? (
            <div className="space-y-3">
              ...
              .map((activity, index) => (
                <div 
                  ...
                  className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/50 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200"  
                >
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xs text-slate-500 ml-1">Start learning to see your progress here</p>
            </div>
          )}
        </div>
      </div>
